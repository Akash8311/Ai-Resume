...
function LegalModal({ type, dark, onClose }) {
  ...
  const termsContent = [
    {
      ...
      body: "By accessing or using AIResume, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service. These terms apply to all visitors, users, and others who access or use the service.",
    },
    {
      title: "2. Use of Service",
      body: "AIResume grants you a limited, non-exclusive, non-transferable license to use the platform for personal, non-commercial resume creation purposes. You agree not to misuse the service, attempt to reverse-engineer any part of it, or use it to generate misleading or fraudulent content.",
    },
    {
    ...
    },
    {
      ...
      body: "The service and its original content, features, and functionality are owned by AIResume and are protected by international copyright, trademark, and other intellectual property laws. Resumes generated by you remain your own property.",
    },
    {
      title: "5. Subscription & Payments",
      body: "Certain features of AIResume require a paid subscription. All payments are processed securely. Subscriptions renew automatically unless cancelled before the renewal date. Refunds are available within 7 days of purchase if no premium features have been used.",
    },
    {
      title: "6. Limitation of Liability",
      body: "AIResume shall not be liable for any indirect, incidental, special, or consequential damages resulting from your use of the service. We do not guarantee job placement or interview success. The service is provided 'as is' without warranties of any kind.",
    },
    {
    ...
    {
      title: "8. Contact",
      body: "For any questions about these Terms of Service, please contact us at legal@airesume.com or write to us at AIResume Inc., 123 Innovation Drive, San Francisco, CA 94105.",
    },
  ];
  ...
  const privacyContent = [
    ...
    },
    {
      ...
      body: "Your data is used to provide and improve AIResume's features, personalize your experience, send important service notifications, and ensure platform security. We use anonymized, aggregated data to improve our AI models.",
    },
    {
    ...
    {
      title: "7. Your Rights",
      body: "You have the right to access, correct, or delete your personal data at any time from your account settings. You may also request a full export of your data. For GDPR or CCPA requests, contact privacy@airesume.com within 30 days.",
    },
    {
      title: "8. Contact & Updates",
      body: "For privacy concerns, contact our Data Protection Officer at privacy@resumeai.com. We will notify you of material changes to this policy via email at least 14 days before they take effect.",
    },
  ];
      ...
      <div style={{
        ...
        >
          <p style={{
            ...
            {isTerms
              ? "Please read these terms carefully before using AIResume. By creating an account, you agree to be bound by these terms."
              : "Your privacy matters to us. This policy explains how AIResume collects, uses, and protects your personal information."}
          </p>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: "#9ca3af", margin: 0 }}>
            © 2026 AIResume Inc. All rights reserved.
          </p>
          <button
            onClick={onClose}
            style={{
    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Plus Jakarta Sans','Segoe UI',sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 52, position: "relative", zIndex: 2, animation: "fadeUp .7s ease both" }}>
          ...
          <span style={{ fontSize: 22, fontWeight: 800, color: "#fff", letterSpacing: "-0.04em" }}>AIResume</span>
        </div>
            ...
            <div style={{ animation: panelIn ? "slideIn .28s ease both" : "slideOut .28s ease both" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, justifyContent: "center", marginBottom: 36 }}>
                ...
                <span style={{ fontSize: 20, fontWeight: 800, color: dark ? "#f1f5f9" : "#111827", letterSpacing: "-0.04em" }}>
                  AI<span style={{ color: G[500] }}>Resume</span>
                </span>
              </div>
                ...
                <>
                  ...
                  <button onClick={handleSubmit} disabled={submitting}
                    ...
                    {submitting
                      ...
                      : mode === "login" ? "Sign In to AIResume →" : "Create My Free Account →"}
                  </button>
