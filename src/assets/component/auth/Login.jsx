...
function LegalModal({ type, dark, onClose }) {
  ...
  const termsContent = [
    {
      ...
      body: "By accessing or using ResumeAI, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service. These terms apply to all visitors, users, and others who access or use the service.",
    },
    {
      title: "2. Use of Service",
      body: "ResumeAI grants you a limited, non-exclusive, non-transferable license to use the platform for personal, non-commercial resume creation purposes. You agree not to misuse the service, attempt to reverse-engineer any part of it, or use it to generate misleading or fraudulent content.",
    },
    {
    ...
    },
    {
      ...
      body: "The service and its original content, features, and functionality are owned by ResumeAI and are protected by international copyright, trademark, and other intellectual property laws. Resumes generated by you remain your own property.",
    },
    {
      title: "5. Subscription & Payments",
      body: "Certain features of ResumeAI require a paid subscription. All payments are processed securely. Subscriptions renew automatically unless cancelled before the renewal date. Refunds are available within 7 days of purchase if no premium features have been used.",
    },
    {
      title: "6. Limitation of Liability",
      body: "ResumeAI shall not be liable for any indirect, incidental, special, or consequential damages resulting from your use of the service. We do not guarantee job placement or interview success. The service is provided 'as is' without warranties of any kind.",
    },
    {
    ...
    {
      title: "8. Contact",
      body: "For any questions about these Terms of Service, please contact us at legal@resumeai.com or write to us at ResumeAI Inc., 123 Innovation Drive, San Francisco, CA 94105.",
    },
  ];
  ...
  const privacyContent = [
    ...
    },
    {
      ...
      body: "Your data is used to provide and improve ResumeAI's features, personalize your experience, send important service notifications, and ensure platform security. We use anonymized, aggregated data to improve our AI models.",
    },
    {
    ...
    {
      title: "7. Your Rights",
      body: "You have the right to access, correct, or delete your personal data at any time from your account settings. You may also request a full export of your data. For GDPR or CCPA requests, contact privacy@resumeai.com within 30 days.",
    },
    {
      ...
      <div style={{
        ...
        >
          <p style={{
            ...
            {isTerms
              ? "Please read these terms carefully before using ResumeAI. By creating an account, you agree to be bound by these terms."
              : "Your privacy matters to us. This policy explains how ResumeAI collects, uses, and protects your personal information."}
          </p>
